        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> Edit Training&nbsp;&nbsp;
                    ...
                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" required autofocus name="topic" id="topic" class="form-control" value="{{$training->topic}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="date" name="training_date" id="training_date" value="{{$training->training_date}}" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" name="speaker" id="speaker" class="form-control" value="{{$training->speaker}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <img src="{{asset($training->featured_image)}}" id="img" width="200"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="control-label col-lg-1 col-sm-2">Short Description</label>
                            <div class="col-lg-6 col-sm-8">
                                <textarea name="short_description" id="short_description" cols="30" rows="3" class="form-control">{{$training->short_description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
