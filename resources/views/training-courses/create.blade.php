            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    >
                        ...
                        <div class="form-group row">
                            <label for="order_number" class="control-label col-sm-2 col-lg-2">Order</label>
                            <div class="col-lg-6 col-sm-8">
                                <input type="number" class="form-control" id="order_number" name="order_number" value="0" min="0" step="1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="photo" class="control-label col-lg-2 col-sm-2">Image<span class="text-danger">(250 x 200)</span></label></label>
                            <div class="col-lg-6 col-sm-8">
