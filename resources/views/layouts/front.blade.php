...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Master Jobs Cambodia">
        @yield('meta')
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <?php $logo = DB::table('logos')->first(); ?>
            ...
            <li class="nav-item ml-auto nv">
                <a class="nav-link" href="#" onclick="chLang(event,'km')"><img src="{{asset('front/img/kh.png')}}" width="20"> ភាសាខ្មែរ</a>
    ...
    <div class="container">
        ...
        <?php
            $subs = DB::table('subscriptions')->where('package_id', 1)->where('active',1)->orderBy('id','desc')->paginate(18);
            $arr = array();
            foreach($subs as $s)
            {
                array_push($arr, $s->employer_id);
            }
            $coms = DB::table('companies')->whereIn('employer_id',$arr)->orderBy('id', 'desc')->get();
        ?>
        <div class="col-md-12 b">
            <div class="row">
                @foreach($coms as $com)
