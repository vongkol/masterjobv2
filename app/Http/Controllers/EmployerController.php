...
class EmployerController extends Controller
{
    ...
    public function subscribe(Request $r)
    {
        ...
        if($i)
        {
            $sms = "<h3>You subscription</h3><hr>";
            $sms .= "<p>You have new subscription to approve. Please check!</p>";
            $sms .= "For more information, please visit the link here: <a href='http://masterjobscambodia.com'>masterjobscambodia.com</a>";
            Right::sms("chanthayon01@gmail.com", "Subscription Information", $sms);
            Right::sms("simsokchamroeun@ymail.com", "Subscription Information", $sms);
            Right::sms("touchsokphea@gmail.com", "Subscription Information", $sms);
            if ($r->session()->get('lang')=='en') {
