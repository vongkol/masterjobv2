...
Route::get('/resource/{id}', "FrontPageController@post");
// coops
Route::get('/coop', "CoopController@index");
Route::get('/coop/create', "CoopController@create");
Route::get('/coop/edit/{id}', "CoopController@edit");
Route::get('/coop/delete/{id}', "CoopController@delete");
Route::post('/coop/save', "CoopController@save");
Route::post('/coop/update', "CoopController@update");